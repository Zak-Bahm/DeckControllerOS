...
echo "MANUAL:   - Each row shows: name, MAC address, connection status, Disconnect/Reconnect button, Forget button"
echo "MANUAL:   - Bottom: Restart Stack, Restart, Power Off buttons"
echo "MANUAL:   - Black background, white text"
echo "MANUAL: Tap 'Disconnect' on Xbox Controller — status bar should update"
echo "MANUAL: Tap 'Reconnect' on DualSense — status bar should update"
...
echo "MANUAL: Tap 'Restart' — confirmation dialog should appear, tap 'Confirm' — status bar updates"
